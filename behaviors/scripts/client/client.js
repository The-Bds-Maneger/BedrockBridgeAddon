...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("bdsbridge:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("bdsbridge:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("bdsbridge:pinky", pinkyEventData);
	}
}
